...
<div class="unit-image unit">
    <div class="unit-image-pic">
        <embed name="playerblog${viewModel.id}" data-bind="uniqueName: true" src="http://www.russia.ru/player/main.swf?103" flashvars="name=${viewModel.params.externalId}&from=blog&blog=true" width="448" height="252" bgcolor="#000000" allowScriptAccess="always" allowFullScreen="true"></embed>
    </div>
